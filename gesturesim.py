...
def gesture_to_motor_command(gesture):
    ...
    gesture_map = {
        ...
        'x-': (-30, -30),  # Backward - both motors backward
        'y+': (-15, 15),   # Left - left motor back, right forward
        'y-': (15, -15),   # Right - left motor forward, right back
        'n': (0, 0)        # Neutral/Stop - no movement
    }
